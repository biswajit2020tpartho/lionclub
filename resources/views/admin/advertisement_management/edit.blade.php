...
<p><a title="Main Module" href="{{ route('getManageAdv') }}"><i class="fa fa-chevron-circle-left "></i> &nbsp; Back To List Data Manage Advertisement</a></p>
...
<div class="row">
	<div class="col-md-12">
		<div class="card">
            ...
            <div class="card-body">
            	<form action="{{ route('postUpdateAdv', $row->id) }}" method="post" enctype="multipart/form-data">
            	@csrf
            	...
            	<div class="row">
            		<div class="col-md-6">
            			<div class="mb-3 ">
					        ...
					        <input type="text" title="Page Title" class="form-control" name="advertisement_title" value="{{ (old('advertisement_title'))?old('advertisement_title'):$row->title }}" placeholder="Page Title" required>					        
            		...
            		<div class="col-md-12">
            			<div class="mb-3 ">
					        ...
					        <textarea name="short_description" class="form-control" id="">{{ (old('short_description'))?old('short_description'):$row->short_description }}</textarea>				        
            		...
            		<div class="col-md-6">
            			<div class="mb-3 ">
					        ...
					        <input type="text" title="Date Of Weding" class="form-control" name="published_date" value="{{ (old('published_date'))?old('published_date'):$row->publish_date }}" id="datepicker" placeholder="Published Date" required autocomplete="off">					        
