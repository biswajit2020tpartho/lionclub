...
<p><a title="Main Module" href="{{ route('getManageCMS') }}"><i class="fa fa-chevron-circle-left "></i> &nbsp; Back To List Data Manage CMS</a></p>
            		...
            		<div class="col-md-6">
            			<!-- <div class="mb-3 ">
					     ...
					     <div class="form-group mb-3">
                            ...
                            <a class="btn btn-danger btn-delete btn-sm" onclick="if(!confirm('Are you sure ?')) return false" href="{{AdminHelper::adminpath()}}/delete-image?image={{$row->featured_image}}&&id={{$row->id}}&&column=featured_image&table=cms_pages"><i class="fa fa-ban"></i> Delete </a></p>
                            @else
