    ...
    <div class="layout-width">
        <div class="navbar-header">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="{{AdminHelper::adminPath()}}" class="logo logo-dark">
                        ...
                        <span class="logo-sm drfgsedg">
                            <img src="{{asset('assets/admin/images/logo-icon.png')}}" alt="" height="50">
                        </span>
                        <span class="logo-lg">
                            <img src="{{asset('assets/admin/images/logo-p.png')}}" alt="" height="17">
                        </span>
                        @else
                    ...
                    <a href="{{AdminHelper::adminPath()}}" class="logo logo-light">
                        ...
                        <span class="logo-sm dfgdg">
                            <img src="{{asset('assets/admin/images/logo-icon.png')}}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{asset('assets/admin/images/logo-p.png')}}" alt="" height="50">
                        </span>
                        @else
                        <span class="logo-sm">{{AdminHelper::getSetting('appname')}}</span>
                        <span class="logo-lg">
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="dropdown topbar-head-dropdown ms-1 header-item notifications-menu">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                            ...
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    <div class="my-3 text-center">
                                        <button type="button" class="btn btn-soft-success waves-effect waves-light" onclick="location.href='{{route("admin.notification")}}'"> Notification <i class="ri-arrow-right-line align-middle"></i></button>
                                    </div>
                                </div>
