...
<div class="row">
	<div class="col-md-6 offset-md-3">
		<div class="card">
            ...
            <div class="card-body">
            	<form action="{{ route('postAddGroup') }}" method="post" enctype="multipart/form-data">
            	@csrf
            	...
            	<div class="row">
            		<div class="form-group mb-3">
            			<div class="mb-3 ">
					        ...
					        <input type="text" title="Group name" class="form-control" name="name" value="{{ old('name') }}" placeholder="Please enter name" required maxlength="50">					        
					        @error('name')
